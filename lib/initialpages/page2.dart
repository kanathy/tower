...
import 'package:tower/initialpages/page3.dart';
      ...
      body: Column(
        ...
        children: [
          ...
          Expanded(
            flex: 9,
            child: Image.asset(
              'lib/assets/images/2.png', // replace with your image path
            ),
          ),
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                // Add yo// Navigate to OnboardingScreen2 when button is pressed
                Navigator.push(
                  context,
